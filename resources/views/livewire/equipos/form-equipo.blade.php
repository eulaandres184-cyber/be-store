...
<div class="form-producto">
        ...
        <div class="bs-form-row">
            <div class="bs-form-group">
                ...
                <input class="bs-input" wire:model.blur="imei"
                       placeholder="15 dígitos" style="font-family:var(--bs-font-mono)" maxlength="20"/>
    ...
    <div class="form-section">
        ...
        <div class="bs-form-row">
            <div class="bs-form-group">
                ...
                <input class="bs-input" wire:model.live="precio_usd"
            ...
            <div class="bs-form-group">
                ...
                <div style="font-size:.7rem;color:var(--bs-muted);margin-top:.2rem">
                    Calculado con dólar blue del día (${{ number_format($this->dolar,0,',','.') }})
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="bs-form-group">
            ...
            <input class="bs-input" wire:model="nombre_producto"
            ...
            <div style="font-size:.7rem;color:var(--bs-muted);margin-top:.2rem">
                Se completa solo al ingresar marca/modelo/capacidad/color
            </div>
        </div>
        <div class="bs-form-row">
            <div class="bs-form-group">
            ...
            <div class="bs-form-group">
                ...
                <input class="bs-input" wire:model="codigo_barras"
                       placeholder="Opcional" style="font-family:var(--bs-font-mono)"/>
            </div>
        </div>
        <div class="bs-form-group">
    ...
    <div style="display:flex;gap:.75rem;flex-wrap:wrap">
        <button wire:click="guardar" wire:loading.attr="disabled"
                class="bs-btn-black" style="padding:.65rem 1.5rem;font-size:.9rem">
