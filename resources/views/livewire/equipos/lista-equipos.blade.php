<div class="bs-panel">
    ...
    <div class="bs-form-row" style="display:grid; grid-template-columns:1fr 1fr 1fr auto; gap:.75rem; margin-bottom:1rem">
        <input type="text" class="bs-input" wire:model.live.debounce.300ms="busqueda" placeholder="Buscar por IMEI..." />
        
        <select class="bs-select" wire:model.live="modeloFiltro">
        ...
        <div style="overflow-x:auto">
            <table class="bs-table">
                ...
                <tr>
                    ...
                    <td>{{ $equipo->producto->modeloCelular->marca ?? '?' }} {{ $equipo->producto->modeloCelular->modelo ?? '?' }}</td>
