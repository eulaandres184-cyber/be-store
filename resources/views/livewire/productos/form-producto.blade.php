...
<div class="form-producto">
    ...
    <div class="form-section">
        ...
        <div class="bs-form-row">
            <div class="bs-form-group">
                ...
                <input class="bs-input" wire:model="codigo_interno" placeholder="BE-0001" style="font-family:var(--bs-font-mono)"/>
            ...
            <div class="bs-form-group">
                ...
                <div class="codigo-field">
                    <input class="bs-input" wire:model="codigo_barras" placeholder="Escaneá o ingresá manualmente" data-scanner="true" style="font-family:var(--bs-font-mono)"/>
                    <button type="button" class="codigo-scan-btn" onclick="document.getElementById('scanner-modal').style.display='flex'; BeScanner.iniciar(function(cod){ @this.set('codigo_barras', cod); document.getElementById('scanner-modal').style.display='none'; BeScanner.detener(); })" title="Escanear con cámara">📷</button>
                </div>
                @error('codigo_barras') <span style="font-size:.75rem;color:var(--bs-danger-text)">{{ $message }}</span> @enderror
                <div style="font-size:.7rem;color:var(--bs-muted);margin-top:.2rem">Pistola USB: apuntá al código y escaneá directamente</div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="bs-form-group">
            ...
            <input class="bs-input" wire:model.live="precio_efectivo" type="number" min="0" step="0.01" placeholder="0.00" style="font-size:1.1rem;font-weight:600"/>
    ...
    <div class="form-section">
        ...
        <div class="bs-form-row">
            ...
            <div class="bs-form-group">
                ...
                <div style="font-size:.7rem;color:var(--bs-muted);margin-top:.2rem">Alerta cuando llegue a este número</div>
            </div>
        </div>
    ...
    <div style="display:flex;gap:.75rem;flex-wrap:wrap">
        <button wire:click="guardar" wire:loading.attr="disabled" class="bs-btn-black" style="padding:.65rem 1.5rem;font-size:.9rem">
            <span wire:loading.remove wire:target="guardar">{{ $modoEdicion ? '💾 Guardar cambios' : '✅ Crear producto' }}</span>
...
<div id="scanner-modal" class="scanner-overlay" style="display:none">
    <div class="scanner-box">
        ...
        <div class="scanner-btns">
            <button type="button" class="bs-btn-secondary w-full" onclick="BeScanner.detener(); document.getElementById('scanner-modal').style.display='none'">Cancelar</button>
        </div>
        <div style="font-size:.72rem;color:var(--bs-muted);text-align:center;margin-top:.5rem">Apuntá la cámara al código de barras</div>
    </div>
</div>
</div>
